...
import (
	...
	"github.com/E7ast1c/burning-chat/internal/gopool"
	"github.com/E7ast1c/burning-chat/pkg"
...
func (c *Chat) anonymousName() string {
	return anonymousUser + "-" + pkg.Hex()
}
